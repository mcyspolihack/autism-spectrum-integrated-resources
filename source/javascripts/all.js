        ...
        if(src == 'images/bang-on-wall-256.png') {
          $('.textbox2').html('');
            $("#harm").attr("src","images/quiet-256.png");
                $('.textbox2').append('<p class="floatright">Go To Quiet Place</p>');

        } else if(src == 'images/quiet-256.png') {
          $('.textbox2').html('');
            $("#harm").attr("src","images/head-protection-256.png");
            $('.textbox2').html('Put on a Safety Helmet or Gloves!');

        } else if(src == "images/head-protection-256.png") {
          $('.textbox2').html('');
            $("#harm").attr("src","images/hug-256.png");
                $('.textbox2').append('<p class="floatright">Gently Rock Back and Fourth</p>');

        } else if(src == "images/hug-256.png") {
          $('.textbox2').html('');
            $("#harm").attr("src","images/singer-256.png");
                $('.textbox2').append('<p class="floatright">Sing With Them</p>');
        ...
        if(src == 'images/suicide-256.png') {
          $('.textbox3').html('');
            $("#suicide").attr("src","images/pills-256.png");
                $('.textbox3').append('<p class="floatright">Administer Medications</p>');
        ...
        if(src == 'images/violent-256.png') {
          $('.textbox4').html('');
            $("#violent").attr("src","images/light-off-256.png");
                $('.textbox4').append('<p class="floatright">Take away sensory objects(Turn Off the Lights)</p>');
        } else if(src == 'images/light-off-256.png') {
          $('.textbox4').html('');
            $("#violent").attr("src","images/pills-256.png");
                $('.textbox4').append('<p class="floatright">Administer Medication</p>');
